...
// 请求与公共工具复用 ./builtin-sdk.cjs（httpRequest 等），本文件只补充 weapi/linuxapi/dateFormat/formatPlayCount

const crypto = require('crypto');

const sdk = require('./builtin-sdk.cjs');

const httpRequest = sdk.httpRequest;
const { sizeFormate, numFix, formatPlayTime, decodeName, formatSingerName, formatSinger, eapi, aes128EcbHex, toNewSongInfo } = sdk;
